    ...
    <section id="rules" class="flex justify-center p-4 md:p-8">
      <TheCard class="max-w-2xl">
        ...
        <div class="flex flex-col mb-4">
          <p>
            Since this is a simple implementation, only the basic rules have
            been adopted.
          </p>
          <p>
            You play against the dealer. Your goal is to reach a higher card
            value than the dealer, but not to exceed 21.
          </p>
        </div>
        <div class="flex flex-col mb-4">
          ...
          <ul class="list-disc list-inside">
            ...
            <li>
              The dealer deals two cards to the player and two cards to the
              dealer.
            </li>
            <li>
              If the player gets an ace and a 10 card, he gets a blackjack and
              wins immediately.
            </li>
            <li>The player can choose to hit or stand.</li>
            <li>
              If the player stayed, the dealer will hit until the total is 17 or
              higher.
            </li>
          </ul>
        </div>
        <div class="flex flex-col mb-4">
          ...
          <ul class="list-disc list-inside">
            ...
            <li>
              You can bet with 10, 25, 50, or 100 credits and only once per
              round.
            </li>
            <li>If you lose the round, you lose your entire bet.</li>
            <li>If you win, you will receive double your bet as a payout.</li>
            <li>
              If you win with a Blackjack, you will receive 2.5 times your bet.
            </li>
